...
class Btn:
    ...
    def __init__(self, text, row, col, rowspan=1):
        self.text = text
        self.bg = 'white'
        self.fg = 'black'
        self.height = 2
    ...
    def makeBtn(self):
        self.btn = Button(bottomframe, text=self.text, command=self.command, bg=self.bg, fg=self.fg, width=self.width, height=self.height, padx=1, pady=self.pady, font=("calibri", 20))
...
display2 = StringVar()
entry2 = Label(topframe, text=display, width=16, height=1, bg="#cde2aa", textvariable=display2, font=("calibri", 44))
